...
public class CombatManager {
    ...
    private static final long LINE_SPACING     = Fixed.fromInt(12);
    /** Наскільки близько до своєї точки в лінії треба підійти, щоб вважатись на місці. */
    private static final long SPREAD_THRESHOLD = Fixed.fromInt(3);
