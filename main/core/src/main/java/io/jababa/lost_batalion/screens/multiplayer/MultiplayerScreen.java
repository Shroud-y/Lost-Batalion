...
public class MultiplayerScreen extends BaseScreen {
    ...
    public void show() {
        super.show();
        // Ключ пошуку СИНХРОНІЗУЄТЬСЯ з полем екрана, а не лишається таким,
        // яким його востаннє поставили. Каталог живе в бекенді й переживає і
        // цей екран, і матч, а поле ключа — ні: воно щоразу порожнє. Без цього
        // рядка гравець, який один раз увів чужий ключ, назавжди отримував
        // фільтр, якого не видно на екрані — його власне лоббі бачили всі, а
        // він не бачив нічийного. Саме так це й проявилось: асиметрично.
